...
void TerrainManager::configureTerrainDefaults(Ogre::Light* light)
{
	...
	int layer = 0;
    //defaultimp.layerList[layer].worldSize = 100;
    //defaultimp.layerList[layer].textureNames.push_back("dirt_grayrocky_diffusespecular.dds");
    //defaultimp.layerList[layer++].textureNames.push_back("dirt_grayrocky_normalheight.dds");
    defaultimp.layerList[layer].worldSize = 30;
    defaultimp.layerList[layer].textureNames.push_back("grass_green-01_diffusespecular.dds");
    defaultimp.layerList[layer++].textureNames.push_back("grass_green-01_normalheight.dds");
    //defaultimp.layerList[layer].worldSize = 200;
    //defaultimp.layerList[layer].textureNames.push_back("growth_weirdfungus-03_diffusespecular.dds");
    //defaultimp.layerList[layer++].textureNames.push_back("growth_weirdfungus-03_normalheight.dds");
}
